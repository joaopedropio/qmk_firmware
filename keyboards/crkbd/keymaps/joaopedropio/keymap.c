...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
	...
	[_COLEMAK_DMH] = LAYOUT_split_3x6_3(
    ...
    */
    ...
    [_PROGRAMMING] = LAYOUT_split_3x6_3(
        _______, LCTL(KC_Q),LCTL(KC_W),LCTL(KC_F),KC_WH_L,KC_WH_R,                 KC_DQUO, KC_LCBR, KC_RCBR, KC_BSLS, KC_PIPE, _______,
        _______, LCTL(KC_A),LCTL(KC_R),LCTL(KC_S),KC_WH_D,KC_WH_U,                 KC_TILD, KC_LBRC, KC_RBRC, KC_GRV,  KC_QUOT, _______,
        _______, LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),KC_D,LCTL(KC_V),                 _______, KC_MINS, KC_UNDS, KC_EQL,  KC_PLUS, _______,
    ...
    */
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,              KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                                 KC_LALT, MO(_QWERTY_NUMBER), KC_SPC,              LT(_SYSTEM, KC_ENT), KC_BSPC, KC_TAB
    ),
    ...
    */
    ...
    [_QWERTY_NUMBER] = LAYOUT_split_3x6_3(
    ...
    */
	...
	[_SYSTEM] = LAYOUT_split_3x6_3(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_PSCR,           QK_BOOT, _______, _______, TO(_QWERTY), TO(_COLEMAK_DMH), _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    if (layer == _QWERTY || layer == _QWERTY_NUMBER) {
        if (is_w_pressed) {
